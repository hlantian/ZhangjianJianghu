...
sub editform {
    ...
    if (($membercode ne "ad")&&($membercode ne "smo")&&($inmembmod ne "yes")&&(($inmembername ne $postermembername)||($usereditpost eq "no"))) {&error("编辑投票帖子&您不是原作者、论坛版主以上级别 , 或者密码错誤，或者此区不允许编辑帖子！");} 
