...
&lbcode(\$inpost) if ($idmbcodestate eq 'on');
if ($emoticons eq "on") { &doemoticons(\$inpost); &smilecode(\$inpost); }
$output .= qq~<table cellpadding=0 cellspacing=0 width=90% bgcolor=$tablebordercolor align=center height="95%">
<tr><td><table cellpadding=4 cellspacing=1 width=100% height="100%">
<tr><td bgcolor=$titlecolor align=center height="20"><font color=$titlefontcolor><b>-=> 预览 <=-</b></td></tr>
<tr><td colspan=2 bgcolor="$postbackcolor" height="*" valign="top"><font color=$postfontcolor>$inpost</td></tr></tr>
<tr><td bgcolor=$titlecolor align=center height="20"><font color=$titlefontcolor><a href="javascript:close()">-=> 关闭 <=-</a></td></tr></table></td></table><p>~;
} else {
@Error=split(/\&/,$inpost);
$output .= qq~<table cellpadding=0 cellspacing=0 width=90% bgcolor=$tablebordercolor align=center height="95%">
<tr><td><table cellpadding=4 cellspacing=1 width=100% height="100%">
<tr><td bgcolor=$titlecolor align=center height="20"><font color=$titlefontcolor><b>-=> $Error[0] <=-</b></td></tr>
<tr><td colspan=2 bgcolor="$postbackcolor" height="*" valign="middle" align="center"><font color=color><b>$Error[1]</b></td></tr></tr>
<tr><td bgcolor=$titlecolor align=center height="20"><font color=$titlefontcolor><a href="javascript:close()">-=> 关闭 <=-</a></td></tr></table></td></table><p>~;
}

&output("预览 - $boardname",\$output,"msg");
exit;
