...
print header(-cookie=>[$tecookie, $lastvisitcookie, $templastcookie, $catlogcookie, $unioncookie, $banfreshcookie, $onlineviewcookie, $advpostcookie, $threadcookie, $viewcookie, $nodisp, $freshtimecookie, $selectstylecookie, $tanchumsgcookie, $namecookie, $passcookie] , -expires=>"$EXP_MODE" , -cache=>"$CACHE_MODES");
