...
<tr><td bgcolor=#FFFFFF valign=middle width=40% align=right><font color=#555555>请输入右边图片的数字</font></td><td bgcolor=#FFFFFF valign=middle><input type=text name="verifynum" size=4 maxlength=4>　　<img src=verifynum.cgi border=0 height=24 align=absmiddle> 如果看不清，请刷新本页</td></tr>
<tr><td bgcolor=#FFFFFF valign=middle colspan=2 align=center><BR><input type=submit name=submit value="登 录"></form></td></tr>
        ...
        <TR>
          <TD>
            <TABLE align=center cellPadding=0 cellSpacing=0 width=200 class=sec_menu>
              ...
              <TR><TD height=18>&nbsp;>> <a href="attachadmin.cgi">文章附件管理器</a></TD></TR>
...
<TABLE align=left cellPadding=0 cellSpacing=0 width=200>
        ...
        <TR>
          <TD>
            <TABLE align=center cellPadding=0 cellSpacing=0 width=200 class=sec_menu>
              <TR><TD height=18>&nbsp;>> <a href="userratinglog.cgi">用户威望操作日志(*)</a></TD></TR>
