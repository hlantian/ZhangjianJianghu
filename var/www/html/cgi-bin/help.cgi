...
print header(-charset=>gb2312 , -expires=>"$EXP_MODE" , -cache=>"$CACHE_MODES");
    if ($inhelpon) {
        $output .= qq~
            <table cellpadding=0 cellspacing=0 width=95% bgcolor=$tablebordercolor align=center>
              <tr>
                <td>
	    ...
	    $output .= qq~
              <table cellpadding=0 cellspacing=0 width=95% bgcolor=$tablebordercolor align=center>
                ...
                <td>
                    <table cellpadding=3 cellspacing=1 width=100%>
                        <tr>
                            <td bgcolor=$miscbacktwo align=center colspan=2><font face="$font" color=$fontcolormisc><b>$boardname的帮助文件</b></td>
                        </tr>
                        <tr>
...
$output .= qq~</tr><tr><td bgcolor=$miscbackone valign=middle align=center colspan=2><font face="$font" color=$fontcolormisc>~;
    ...
    <font face="$font" color=$fontcolormisc>
    您目前的身份是： <font color=$fonthighlight><B><u>$inmembername</u></B></font> ，如果要使用其他用户身份，请在下面输入用户名和密码。如果不想改变用户身份，请留空。<BR>
