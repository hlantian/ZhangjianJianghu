...
sub options {
    ...
    <td><b>认证论坛 - 有新的帖子</b></td><td><input type="text" name="rz_havenew" value="$rz_havenew"
     onblur="document.images.i_rz_havenew.src='$imagesurl/images/'+this.value;">
     </td><td><img src="$imagesurl/images/$rz_havenew" name="i_rz_havenew"></td></tr>
     
      <tr>
    <td><b>认证论坛 - 没有新的帖子</b></td><td><input type="text" name="rz_nonew" value="$rz_nonew"
     onblur="document.images.i_rz_nonew.src='$imagesurl/images/'+this.value;">
     </td><td><img src="$imagesurl/images/$rz_nonew" name="i_rz_nonew"></td></tr>
    ...
    <td><b>精华区</b></td><td><input type="text" name="jh_pic" value="$jh_pic"
     ...
     <tr><td colspan=3 bgcolor=#EEEEEE>论坛按钮</td></tr>
                ...
                </td><td><img src=$imagesurl/images/$mypost_blogo name="i_new_mypost"></td>
                </tr>
               ...
               </td><td><img src=$imagesurl/images/$new_JH name="i_new_JH"></td> 
               </tr> 
