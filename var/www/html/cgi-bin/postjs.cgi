...
&nbsp;　<font color=$fontcolormisc>字体：</font>
...
　<font color=$fontcolormisc>字号：</font>
...
　<font color=$fontcolormisc>颜色：</font>
...
<BR>　 『 <span style=cursor:hand onClick=javascript:openeditor()><font color=$fonthighlight>HTML 编辑器</font></span> 』 『 <span style=cursor:hand onClick=javascript:openascii()><font color=#990000>ASCII 字形生成器</font></span> 』 『 <span style=cursor:hand onClick=javascript:replac()><font color=$fonthighlight>替换文本</font></span> 』 <input type="button" class="button" name="lbcode_save" value="储存内容" onClick="postSave(this)"> <input type="button" class="button" name="lbcode_load" value="读取内容" onClick="postLoad()"><bR>&nbsp;
~;
1;
