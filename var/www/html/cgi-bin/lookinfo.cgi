...
$output .= qq~
<table width=$tablewidth bordercolor=$tablebordercolor align=center cellpadding=0 cellspacing=0 ><tr><td><div align="center">用 户 等 级</div></td></tr></table>
	...
	<tr><td bgcolor=$forumcolorone>$mtitle0</td><td  bgcolor=$forumcolortwo>0</td><td><img src=$imagesurl/images/$mgraphic0></td><tr>
...
<table width=$tablewidth bordercolor=$tablebordercolor align=center cellpadding=0 cellspacing=0 ><tr><td><div align="center">社 区 信 息</div></td></tr></table>
<table width=$tablewidth border=1 bordercolor=$tablebordercolor align=center cellpadding=0 cellspacing=0 ><br>
        ...
        <tr><td bgcolor=$forumcolorone>每个精华帖子增加的经验：</td><td  bgcolor=$forumcolortwo>$addjhjy</td><tr>
        <tr><td bgcolor=$forumcolorone>每个精华帖子增加的魅力：</td><td  bgcolor=$forumcolortwo>$addjhml</td><tr>
        ...
        <tr><td bgcolor=$forumcolorone>每登录一次折算的经验数：</td><td  bgcolor=$forumcolortwo>$ltojy</td><tr>
        ...
        <tr><td bgcolor=$forumcolorone>每次登录时增加的魅力：</td><td  bgcolor=$forumcolortwo>$loginml</td><tr>
