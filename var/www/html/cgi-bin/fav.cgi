...
$favdescript=~s/^>>//;
&lbcode(\$favdescript);
$output.=qq~<table cellpadding=6 cellspacing=0 width=$tablewidth height=24 align=center style="border:1 solid $tablebordercolor"><tr><td bgcolor=$catback $catbackpic height=24 align=left><img src=$imagesurl/images/cat.gif border=0 width=9 height=9> <font color=$catfontcolor><b>收藏夹介绍</b></font></td></tr></table>
...
<td width=37 bgcolor=$titlecolor align=center $catbacks><font color=$titlefontcolor><b>选</b></font></td></tr></table>
...
#	    }
    ...
    if (($screenmode >=8)||($tablewidth > 770)) { $topictitlemax = 60; } else {$topictitlemax = 40;}
...
fav.checked.value=action;
	if(action == 'rename'){
		...
		fav.submit();
            ...
            <td bgcolor=$titlecolor colspan=3 align=center>
