...
<input type=text name="postfontcolortwo" value="$postfontcolortwo" size=7 maxlength=7 onclick="javascript:selcolor(this,postfontcolortwo2)" style="cursor:hand">　默认：#555555</td>
		...
		<input type=text name="newpolllogo" value="$newpolllogo" onblur="document.images.i_newpolllogo.src='$imagesurl/images/'+this.value;">　
                ...
                <td bgcolor=#FFFFFF>
                <input type=text name="mypost_blogo" value="$mypost_blogo" onblur="document.images.i_new_mypost.src='$imagesurl/images/'+this.value;">　
                <img src=$imagesurl/images/$mypost_blogo name="i_new_mypost"></td>
                </tr>
               ...
               <td bgcolor=#FFFFFF> 
               <input type=text name="new_JH" value="$new_JH" onblur="document.images.i_new_JH.src='$imagesurl/images/'+this.value;">　
               <img src=$imagesurl/images/$new_JH name="i_new_JH"></td> 
               </tr> 
...
~;
	...
	print qq~
		...
		~;
                ...
                <tr>
                <td bgcolor=#FFFFFF colspan=2>
                <font face=宋体 color=#333333><b>分论坛是否使用威望积分制度</b></font></td>
                <td bgcolor=#FFFFFF valign=middle align=left>
                $tempoutput</td>
                </tr>
                ~;
		...
		$tempoutput = "<select name=\"postjf\">\n<option value=\"yes\">使用\n<option value=\"no\">不使用\n</select>\n";
                ...
                <tr>
                <td bgcolor=#FFFFFF colspan=2>
                <font face=宋体 color=#333333><b>分论坛是否使用帖子积分标签</b></font></td>
                <td bgcolor=#FFFFFF valign=middle align=left>
                $tempoutput</td>
                </tr>
		~;
		...
		$tempoutput = "<select name=\"dispshowcount\">\n<option value=\"no\">不显示\n<option value=\"yes\">显示\n</select>\n";
                $tempoutput =~ s/value=\"$dispshowcount\"/value=\"$dispshowcount\" selected/;
                print qq~
                <tr>
                <td bgcolor=#FFFFFF colspan=2>
                <font face=宋体 color=#333333><b>附件下载是否显示点击数（占用很大资源，推荐不采用）</b></font></td>
                <td bgcolor=#FFFFFF valign=middle align=left>
                $tempoutput</td>
                </tr>
		~;
		...
		~;
                ...
                <td bgcolor=#FFFFFF>
                <input type=text name="maxpoststr" value="$maxpoststr" size=5 maxlength=5>　如不想限制，可留空或写 0，不得少于 100。</td>
                </tr>
                ...
                <td bgcolor=#FFFFFF>
                <input type=text name="onlinepost" value="$onlinepost" size=5 maxlength=5>　单位：秒，建议设置 600，如不想限制，就留空或设 0。</td>
                </tr>
                ~;
		...
		~;
                ...
                <tr>
                <td bgcolor=#FFFFFF colspan=2>
                <font color=#333333>管理帖子（删除、移动、锁定）后，<BR>是否发短消息通知用户？</font></td>
                <td bgcolor=#FFFFFF>
                $tempoutput</td>
                </tr>
		~;
...
function DeleteAllow()
{
	...
	{
		MAINFORM.allowusers.innerText = eval("MAINFORM.allowusers.innerText.replace(/," + name + "/ig" + ",'')");
		MAINFORM.allowusers.innerText = eval("MAINFORM.allowusers.innerText.replace(/" + name + ",/ig" + ",'')");
		MAINFORM.allowusers.innerText = eval("MAINFORM.allowusers.innerText.replace(/" + name + "/ig" + ",'')");
	}
}
function ClearAllow()
{
	if (confirm("你确定要清空所有只允许进入的用户ID？"))
		...
		<tr>
                ...
                <tr>
                <td bgcolor=#FFFFFF colspan=2>
                <font color=#333333>进入论坛的最小魅力数<BR>小于此魅力的，不能进入，注意：这个数字必须是大于 0 的。</td>
                <td bgcolor=#FFFFFF>
                <input type=text name="enterminml" value="$enterminml" size=10 maxlength=10>　注意用半角，前后不要有空格，如不想限制，就留空或设 0。</td>
                </tr>

                <tr>
                <td bgcolor=#FFFFFF colspan=2>
                <font color=#333333>进入论坛的最小经验数<BR>小于此经验的，不能进入，注意：这个数字必须是大于 0 的。</td>
                <td bgcolor=#FFFFFF>
                <input type=text name="enterminjy" value="$enterminjy" size=10 maxlength=10>　注意用半角，前后不要有空格，如不想限制，就留空或设 0 。</td>
                </tr>
...
foreach (@dirdata1) { unlink ("${lbdir}cache/$_"); }
    ...
    if (-e $filerequire && -w $filerequire) {
        print qq~<tr><td bgcolor=#333333" colspan=2><font color=#FFFFFF><b>欢迎来到论坛管理中心 / 分论坛风格设定</b></td></tr>
