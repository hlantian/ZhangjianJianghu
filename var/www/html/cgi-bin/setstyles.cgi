...
~;
	...
	print qq~
		...
		~;
                ...
                <td bgcolor=#FFFFFF>
                <input type=text name="onlinemessage" value="$onlinemessage" size=5 maxlength=5>　单位：秒，建议设置 600，如不想限制，就留空。</td>
                </tr>
                ...
                <td bgcolor=#FFFFFF>
                <input type=text name="onlinepost" value="$onlinepost" size=5 maxlength=5>　单位：秒，建议设置 600，如不想限制，就留空。</td>
                </tr>
                ~;
		...
		<tr>
		<td bgcolor=#FFFFFF colspan=2>
		<font color=#333333>允许会员自行修改个人头衔需要达到的发言数</font></td>
		<td bgcolor=#FFFFFF>
		...
		~;
                ...
                <tr>
                <td bgcolor=#FFFFFF colspan=2>
                <font face=宋体 color=#333333><b>附件下载是否显示点击数（占用较多资源，推荐不采用）</b></font></td>
                <td bgcolor=#FFFFFF>
                $tempoutput</td>
                </tr>
		~;
		...
		$tempoutput = "<select name=\"wwjf\">\n<option value=\"yes\">使用\n<option value=\"no\">不使用\n</select>\n";
                ...
                <tr>
                <td bgcolor=#FFFFFF colspan=2>
                <font face=宋体 color=#333333><b>论坛是否使用威望积分制度</b></font></td>
                <td bgcolor=#FFFFFF>
                $tempoutput</td>
                </tr>
                ~;
		...
		$tempoutput = "<select name=\"postjf\">\n<option value=\"yes\">使用\n<option value=\"no\">不使用\n</select>\n";
                ...
                <tr>
                <td bgcolor=#FFFFFF colspan=2>
                <font face=宋体 color=#333333><b>论坛是否使用帖子积分标签</b></font></td>
                <td bgcolor=#FFFFFF>
                $tempoutput</td>
                </tr>
		~;
