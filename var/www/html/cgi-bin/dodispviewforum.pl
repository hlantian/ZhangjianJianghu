...
if ($inmembername ne "客人") {
	...
	$deltopicmore1 = qq~论坛选项 (<a href=delforumcache.cgi?forum=$inforum title=如果本区有部分数据滞后的话，可以用此功能>更新该区缓存</a>)~;
    ...
    $output .= qq~<table cellspacing=0 cellpadding=0 width=$tablewidth bgcolor=$tablebordercolor align=center>
<tr><td><table cellspacing=1 cellpadding=6 width=100%>
<tr><td width=80% bgcolor=$titlecolor $catbackpic><font color=$titlefontcolor><b>-=> LeoBBS 论坛图例</b></font></td>
...
<td><img src=$imagesurl/images/topicnew3.gif width=14> 上次来之后发表</td>
<td><img src=$imagesurl/images/topichot3.gif width=14> <img src=$imagesurl/images/closedbhot.gif width=13> 上次来之后发表</td>
<td><img src=$imagesurl/images/topiclocked3.gif width=14> 关闭的主题，不接受回复</td>
<td><img src=$imagesurl/images/abstop.gif width=17> <img src=$imagesurl/images/lockcattop.gif width=15> <img src=$imagesurl/images/locktop.gif width=15> 固顶的主题</td>
...
~;
    ...
    $output .= qq~<table cellspacing=0 cellpadding=0 width=$tablewidth align=center bgcolor=$tablebordercolor>
<tr><td><table cellspacing=1 cellpadding=6 width="100%"><tr>
<td width=80% bgcolor=$titlecolor $catbackpic><font color=$titlefontcolor><b>-=> LeoBBS 论坛图例</b></font></td>
<td noWrap bgcolor=$titlecolor width=20% align=right $catbackpic><font color=$titlefontcolor>所有时间均为 - $basetimes &nbsp;</td></tr><tr><td colspan=3 bgcolor=$forumcolorone>
...
<td width=28%><img src=$imagesurl/images/topiclocked3.gif width=14> <img src=$imagesurl/images/closedb1.gif width=13> 关闭了的主题，不接受回复</td>
<td width=21%><img src=$imagesurl/images/abstop.gif width=17> <img src=$imagesurl/images/lockcattop.gif width=15> <img src=$imagesurl/images/locktop.gif width=15> (总、区)固顶的主题</td>
