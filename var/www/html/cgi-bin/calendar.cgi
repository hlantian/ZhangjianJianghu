...
$catbackpic  = 'background="'.$imagesurl.'/myimages/'.$catbackpic.'"' if($catbackpic ne "");
&title;
if($action eq "event"){
...
<tr><td height="*" colspan="2" valign="top" style="border:1 solid $miscbackone;padding:2px">$event_temp</td></tr>
...
$add_event = qq~<a href="$thisprog?action=event"><img src="$imagesurl/images/newevent.gif" width="99" height="25" alt="增加新事件" border="0"></a>~ if($membercode eq "ad");
...
<tr><td bgcolor=$miscbackone align="center"><table width="80%" border="0" cellspacing="0"><tr>$event_list</tr></table></td></tr></table></td></tr></table>
<table border="0" cellspacing="2" cellpadding="4" width="$tablewidth" align="center">
<tr>
<td width="*">$add_event</td>
