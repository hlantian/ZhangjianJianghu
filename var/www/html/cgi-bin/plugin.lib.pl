...
sub updateuserinfo {  #利用变化量来更新用户信息
    my($nametocheck,$cposts, $creplys, $crating,$cjinyan,$cmeili,$cmoney,$cpostdel,$cjhcount,$conlinetime) = @_;
#     用户名，发贴数变化量，回复数变化量，威望变化量，经验变化量，魅力变化量，金钱变化量，贴子被删除数变化量，精华贴变化量，在线时间变化量
