...
$output .= qq~
<table width=$tablewidth align=center cellspacing=0 cellpadding=1 bgcolor=$navborder><caption align=left>>>> 在这里您可以把有问题的帖子发送给管理人员处理</caption><tr><td><table width=100% cellspacing=0 cellpadding=3 height=25><tr><td bgcolor=$navbackground><img src=$imagesurl/images/item.gif align=absmiddle width=11> <font face="$font" color=$navfontcolor> <a href="leobbs.cgi">$boardname</a>  → 报告有问题的贴子<td bgcolor=$navbackground align=right></td></tr></table></td></tr></table>
<p>
...
管理员，您好，由于如下原因，我向你报告这有问题的贴子：
	...
	<tr>
    		<td colspan=2 bgcolor=$miscbackone align=center><input type=hidden name="emailtopictitle" value="$topictitle"><input type=submit value="发送报告" name="Submit"></table></td></form></tr></table>
    ~;
