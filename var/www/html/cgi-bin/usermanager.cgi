...
sub searchoptions {
       my $memteam1 = qq~<option value="rz1">$defrz1</option>~ if ($defrz1 ne "");
       my $memteam2 = qq~<option value="rz2">$defrz2</option>~ if ($defrz2 ne "");
       my $memteam3 = qq~<option value="rz3">$defrz3</option>~ if ($defrz3 ne "");
       my $memteam4 = qq~<option value="rz4">$defrz4</option>~ if ($defrz4 ne "");
       my $memteam5 = qq~<option value="rz5">$defrz5</option>~ if ($defrz5 ne "");
