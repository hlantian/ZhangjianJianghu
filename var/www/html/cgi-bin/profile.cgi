...
<table width="100%" border="0" cellspacing="0" cellpadding="4">
  ...
  <tr>
    ...
    <td valign=middle><font color=$fontcolormisc>魅力：</font></td>
    <td valign=middle><font color=$fontcolormisc>$meili</font></td>
    <td valign=middle><font color=$fontcolormisc>经验：</font></td>
    <td valign=middle><font color=$fontcolormisc>$jingyan</font></td>
  </tr>
  <tr bgcolor=$miscbacktwo>
  ...
  <tr bgcolor=$miscbacktwo align=center>
    ...
    <td valign=middle colspan=2><span onClick="openScript('messanger.cgi?action=new&touser=$inmember&actionto=msg', 420, 320)" style="cursor: hand">发送一个短消息给$membername</span></td>
