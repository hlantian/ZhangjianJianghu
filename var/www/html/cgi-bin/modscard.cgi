...
&whosonline("$inmembername\t版主签到\tnone\t论坛版主签到\t") unless(-e "$filetoopens.lck");
...
sub top_page{
	...
	$output .= qq~
<table cellPadding="0" cellSpacing="0" border="0" width="420" bgColor="$tablebordercolor" align="center" height="320">
<tr><td>
<table cellPadding="5" cellSpacing="1" border="0" width="100%" height="100%">
<tr><td bgcolor="$titlecolor" align="center" colspan="2"><font color="$fontcolormisc"><b>坛主公告</b></font></td></tr>
...
<table cellPadding="5" cellSpacing="1" border="0" width="100%" height="100%">
<tr>
<td bgcolor="$titlecolor" align="center"><a href="$thisprog?action=pcard_search"><font color="$fontcolormisc">[搜寻]</font></a></td>
<td bgcolor="$titlecolor" align="center"><font color="$fontcolormisc"><b>签到记录 - $checkaction</b></font></td>
</tr>
...
<tr><td>
<table cellPadding="5" cellSpacing="1" border="0" width="100%" height="100%">
<tr><td bgcolor="$titlecolor" align="center" colspan="2"><font color="$fontcolormisc"><b>类型搜寻</b></font></td></tr>
<form action="$thisprog" method="POST">
<input type="hidden" name="start_page" value="1">
...
<tr><td bgcolor="$titlecolor" align="center" colspan="2"><font color="$fontcolormisc"><b>会员搜寻</b></font></td></tr>
<form action="$thisprog" method="POST">
...
<tr><td>
<table cellPadding="5" cellSpacing="1" border="0" width="100%" height="100%">
<tr><td bgcolor="$miscbacktwo" align="center" height="20"><font color="$fontcolormisc"><b>搜寻完成</b></font></td></tr>
