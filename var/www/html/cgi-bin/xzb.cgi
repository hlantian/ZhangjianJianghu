...
if (!(-e "$filetoopens.lck")) {
	...
	<table cellpadding=0 cellspacing=0 width=97% bgcolor=#000000 align=center>
	                <tr>
	                    <td>
