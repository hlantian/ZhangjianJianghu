...
else
{
	...
	&error("权限错误&监狱中的犯人不允许访问 FTP 联盟！") if ($membercode eq "banned" || $membercode eq "masked");
...
function AdminView()
{
	...
	$output .= "\n<table width=$tablewidth><tr><td>　　<a href=$thisprog?action=add><font color=$fonthighlight><b>出售新的 FTP 服务</b></font></a></td></tr></table>" if ($membercode eq "ad" || ",$saleusers," =~ /,$inmembername,/i);
	$output .= qq~
<table cellPadding=0 cellSpacing=0 width=$tablewidth bgcolor=$tablebordercolor align=center><tr><td><table cellPadding=6 cellSpacing=1 width=100%>
<tr style="color: $titlefontcolor; font-weight: bold; background-color: $titlecolor" align=center><td $catbackpic>FTP 名称 (点击购买)</td><td $catbackpic>状态</td><td $catbackpic>类型</td><td $catbackpic>管理员</td><td $catbackpic>当前售价</td><td $catbackpic>威望要求</td><td $catbackpic>购买限制</td><td $catbackpic>得分</td></tr>~;
	...
	$output .= qq~</table></td></tr></table><table cellPadding=0 cellSpacing=0 width=$tablewidth><tr><td align=right width=100% style="line-height: 150%">&copy; <b>程序设计: <a href=http://www.94cool.net target=_blank><font color=5599ff>94Cool</font><font color=ff9955>.net</font></a></b> <a href=mailto:Jim_White\@etang.com>BigJim</a> </td></tr></table>~;
...
sub info
{
	...
	$output .= qq~
<table cellPadding=0 cellSpacing=0 width=$tablewidth bgcolor=$tablebordercolor align=center><tr><td><table cellPadding=6 cellSpacing=1 width=100%>
<tr style="color: $titlefontcolor; font-weight: bold; background-color: $titlecolor" align=center><td>查看者</td><td>来自IP</td><td>来源鉴定</td><td>购买时间</td></tr>~;
...
{#输出头部导航栏
	...
	$output .= qq~
<br>
<table width=$tablewidth align=center cellspacing=0 cellpadding=1 bgcolor=$navborder><caption align=left>>>> 在这里您可以查看本站 FTP 联盟的列表及详细信息</caption><tr><td><table width=100% cellspacing=0 cellpadding=3 height=25><tr><td bgcolor=$navbackground><img src=$imagesurl/images/item.gif align=absmiddle width=11> <font face="$font" color=$navfontcolor> <a href="leobbs.cgi">$boardname</a> → <a href=$thisprog>FTP 联盟</a> → $jump<td bgcolor=$navbackground align=right></td></tr></table></td></tr></table>
<p>
~;
	return;
}
