...
#####################################################
	...
	$titleoutput =~ s/\$/\\\$/isg;
	$titleoutput =~ s/\@/\\\@/isg;
	print FILE qq(\$titleoutput1 = qq~$titleoutput1~;\n);
