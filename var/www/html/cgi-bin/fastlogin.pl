...
$output .= qq~<tr><td bgcolor=$titlecolor colspan=3 $catbackpic><font color=$titlefontcolor><B>-=> 快速登录入口</B>　 [ IP 是：$trueipaddress， 来自：$fromwhere1 。　操作系统：$osinfo， 浏览器：$browseinfo ]</td></tr>
<script>
