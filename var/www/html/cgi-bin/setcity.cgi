...
if (($membercode eq "ad") && ($inpassword eq $password) && ($password ne "") && ($inmembername ne "") && (lc($inmembername) eq lc($membername))) {
    ...
    if ($action eq "process") {
        ...
        if (-e $filetomake && -w $filetomake) {
                ...
                <tr>
                <td bgcolor=#FFFFFF valign=middle align=left width=40%>
                <font face=宋体 color=#333333><b>每个精华帖子增加的经验</b></font></td>
                <td bgcolor=#FFFFFF valign=middle align=left>
                <input type=text size=20 name="addjhjy" value="$addjhjy"> 默认：100</td>
                </tr>
                
                <tr>
                <td bgcolor=#FFFFFF valign=middle align=left width=40%>
                <font face=宋体 color=#333333><b>每个精华帖子增加的魅力</b></font></td>
                <td bgcolor=#FFFFFF valign=middle align=left>
                <input type=text size=20 name="addjhml" value="$addjhml"> 默认：100</td>
                </tr>
                ...
                <tr>
                <td bgcolor=#FFFFFF valign=middle align=left width=40%>
                <font face=宋体 color=#333333><b>每登录一次折算的经验数</b></font></td>
                <td bgcolor=#FFFFFF valign=middle align=left>
                ...
                <tr>
                <td bgcolor=#FFFFFF valign=middle align=left width=40%>
                <font face=宋体 color=#333333><b>每次登录增加的魅力</b></font></td>
                <td bgcolor=#FFFFFF valign=middle align=left>
