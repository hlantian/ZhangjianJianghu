...
<tr><td bgColor=$miscbacktwo colSpan=2 align=center><form action=messanger.cgi method=POST name=FORM><input type=hidden name=action value="send"><input type=hidden name=check value="yes"><font color=$fontcolormisc><b>请完整输入下列信息</b></td></tr>
<tr>
...
elsif ($action eq "send")
{
	...
	if (($onlinetime + $onlinetimeadd) < $onlinemessage && $onlinemessage ne "" && $membercode ne "ad" && $membercode ne "smo" && $membercode ne "cmo" && $membercode ne "mo" && $membercode ne "amo" && $membercode !~ /^rz/) { $onlinetime = $onlinetime + $onlinetimeadd; &error("短消息&本论坛不允许在线时间少于 $onlinemessage 秒的用户发送短消息！你目前已经在线 $onlinetime 秒！&msg"); }
...
<tr><td bgColor=$miscbacktwo align=center colSpan=3><font color=$fontcolormisc><b>欢迎使用短消息发送，$inmembername</b></td></tr>
...
<input type=hidden name=action value="delete">
<tr><td bgColor=$miscbacktwo align=center colSpan=4><font color=$fontcolormisc>$dxxboom<b>欢迎使用您的收件箱，$membername</b></td>
</tr>
...
<tr><td bgColor=$miscbacktwo align=center colSpan=3><font color=$fontcolormisc><b>欢迎使用短消息接收，$inmembername</b></td></tr>
...
<tr><td bgColor=$miscbacktwo align=center colSpan=2><font color=$fontcolormisc><b>欢迎使用您的收件箱，$inmembername</b></td></tr>
...
<tr> 
<form action=$thisprog method=POST name=FORM><input type=hidden name=action value="send"><input type=hidden name=touser value="$from"><input type=hidden name=msgtitle value="$remsg">
...
<table cellPadding=0 cellSpacing=0 width=95% bgColor=$tablebordercolor align=center><tr><td>
