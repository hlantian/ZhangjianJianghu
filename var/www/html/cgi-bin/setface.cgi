...
<BODY>
<br>
<table width=$tablewidth align=center cellspacing=0 cellpadding=1 bgcolor=$navborder><caption align=left>>>> 在这里您可以购买、装备、赠送、设置和管理你的虚拟形象</caption><tr><td><table width=100% cellspacing=0 cellpadding=3 height=25><tr><td bgcolor=$navbackground><img src=$imagesurl/images/item.gif align=absmiddle width=11> <font face="$font" color=$navfontcolor> <a href="leobbs.cgi">$boardname</a> → <a href=face.cgi>$plugname</a> <img src=$imagesurl/images/fg.gif width=1 height=10> [<a href=setface.cgi>后台管理</a>]<td bgcolor=$navbackground align=right></td></tr></table></td></tr></table>
<p>
<table cellspacing=1 cellpadding=5 width=$tablewidth bgcolor=$titleborder border=0 align="center">
<tr><td height=30 bgcolor=$titlecolor $catbackpic>
...
{
    $output .= qq~
    <table cellspacing=1 cellpadding=5 width=$tablewidth bgcolor=$tablebordercolor border=0 align="center">
...
</table></td></tr></table><meta http-equiv="refresh" content="1; url=$thisprog?action=sortm">~;
    }
}
