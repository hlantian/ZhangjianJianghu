...
if ($membercode ne 'ad' && $membercode ne 'smo' && $inmembmod ne 'yes') {
	...
	&ERROROUT("你不允许进入该论坛，你的魅力为 $meili，而本论坛只有魅力大于等于 $enterminml 的才能进入！") if ($enterminml > 0 && $meili < $enterminml);
	&ERROROUT("你不允许进入该论坛，你的经验为 $jingyan，而本论坛只有经验大于等于 $enterminjy 的才能进入！") if ($enterminjy > 0 && $jingyan < $enterminjy);
    }
}
...
if (($screenmode >=8)||($tablewidth > 770)) { $topictitlemax = 65; } else { $topictitlemax = 30; }
